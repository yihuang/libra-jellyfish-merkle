/// Copy and modifed from libra/types/
pub mod proto;
pub mod transaction {
...
pub mod account_state_blob {
    ...
    #[derive(Debug, Clone, Eq, PartialEq, Serialize, Deserialize, CryptoHasher)]
...
pub mod proof {
    ...
    use libra_crypto::{
        hash::{
            CryptoHash, CryptoHasher, SparseMerkleInternalHasher, ACCUMULATOR_PLACEHOLDER_HASH,
    ...
    impl TryFrom<crate::proto::types::SparseMerkleProof> for SparseMerkleProof {
        ...
        fn try_from(proto_proof: crate::proto::types::SparseMerkleProof) -> Result<Self> {
            ...
            let siblings =
                from_proto_siblings(proto_proof.siblings, *SPARSE_MERKLE_PLACEHOLDER_HASH)?;
    ...
    impl From<SparseMerkleProof> for crate::proto::types::SparseMerkleProof {
        fn from(proof: SparseMerkleProof) -> Self {
            ...
            proto_proof.siblings =
                into_proto_siblings(proof.siblings, *SPARSE_MERKLE_PLACEHOLDER_HASH);
            proto_proof
        }
    }
